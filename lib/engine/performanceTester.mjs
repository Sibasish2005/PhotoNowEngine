...
/**
 * Fetches page HTML and resource headers over HTTP/HTTPS with timeout.
 */
function fetchUrlText(targetUrl, timeoutMs = 8000) {
    ...
    const req = client.get(
      ...
      (res) => {
        ...
        if ([301, 302, 307, 308].includes(res.statusCode) && res.headers.location) {
          ...
          return resolve(fetchUrlText(redirectUrl, timeoutMs));
        }
